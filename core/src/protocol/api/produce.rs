...
pub fn serialize_produce_request(data:ProduceRequest,version:i32, buf: &mut BytesMut) -> Result<(),Error> {
    match version {
...
pub fn deserialize_produce_response<T>(version:i32, buf: &mut T) -> ProduceResponse where T: Iterator<Item=u8> {
    match version {
...
impl TryFrom<ProduceRequest8> for ProduceRequest0{
    ...
    fn try_from(latest:ProduceRequest8) -> Result<Self, Self::Error> {
        if latest.transactional_id.is_some() {
            Err(Error::OldKafkaVersion("ProduceRequest",0,"transactional_id"))?
        }
        Ok(ProduceRequest0{
            acks: latest.acks,
...
impl TryFrom<ProduceRequest8> for ProduceRequest1{
    ...
    fn try_from(latest:ProduceRequest8) -> Result<Self, Self::Error> {
        if latest.transactional_id.is_some() {
            Err(Error::OldKafkaVersion("ProduceRequest",1,"transactional_id"))?
        }
        Ok(ProduceRequest1{
            acks: latest.acks,
            timeout: latest.timeout,
...
impl TryFrom<ProduceRequest8> for ProduceRequest2{
    ...
    fn try_from(latest:ProduceRequest8) -> Result<Self, Self::Error> {
        if latest.transactional_id.is_some() {
            Err(Error::OldKafkaVersion("ProduceRequest",2,"transactional_id"))?
        }
        Ok(ProduceRequest2{
            acks: latest.acks,
            timeout: latest.timeout,
...
impl From<ProduceResponseResponses0> for ProduceResponseResponses8{
    fn from(older:ProduceResponseResponses0) -> Self {
        ProduceResponseResponses8{
            ...
            ..ProduceResponseResponses8::default()
        }
    }
}

impl From<ProduceResponseResponsesPartitionResponses0> for ProduceResponseResponsesPartitionResponses8{
...
impl From<ProduceResponseResponsesPartitionResponses1> for ProduceResponseResponsesPartitionResponses8{
...
impl From<ProduceResponseResponsesPartitionResponses2> for ProduceResponseResponsesPartitionResponses8{
...
impl From<ProduceResponseResponsesPartitionResponses3> for ProduceResponseResponsesPartitionResponses8{
...
impl From<ProduceResponseResponsesPartitionResponses4> for ProduceResponseResponsesPartitionResponses8{
...
impl From<ProduceResponseResponsesPartitionResponses5> for ProduceResponseResponsesPartitionResponses8{
...
impl From<ProduceResponseResponsesPartitionResponses6> for ProduceResponseResponsesPartitionResponses8{
...
impl From<ProduceResponseResponsesPartitionResponses7> for ProduceResponseResponsesPartitionResponses8{
