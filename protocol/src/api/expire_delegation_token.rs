use super::prelude::*;
pub type ExpireDelegationTokenRequest = ExpireDelegationTokenRequest0;
impl ApiCall for ExpireDelegationTokenRequest0 {
    type Response = ExpireDelegationTokenResponse0;
...
impl ExpireDelegationTokenResponse0 {
