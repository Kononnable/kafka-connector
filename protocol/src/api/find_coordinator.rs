use super::prelude::*;
pub type FindCoordinatorRequest = FindCoordinatorRequest0;
impl ApiCall for FindCoordinatorRequest0 {
    type Response = FindCoordinatorResponse0;
