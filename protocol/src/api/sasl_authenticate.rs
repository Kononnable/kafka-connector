use super::prelude::*;
pub type SaslAuthenticateRequest = SaslAuthenticateRequest0;
impl ApiCall for SaslAuthenticateRequest0 {
    type Response = SaslAuthenticateResponse0;
...
impl SaslAuthenticateResponse0 {
